...
import {onWinAllProducts} from '../helpers/onWinProducts';
import DeleteIcon from '../assets/delete_icon.png';

const OnwinCartItemComponent = ({item}) => {
  ...
  const productImage = onWinAllProducts.find(p => p.name === item.name)?.image;
...
export default OnwinCartItemComponent;
